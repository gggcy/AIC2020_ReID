...
def main(args):
    ...
    g_file = open('gao_crop_333.pkl', 'wb')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='/data/home/cunyuangao/Project/AIC2020_ReID/mgn/logs/logs/model_288_384/model_best.pth.tar')
    ...
    parser.add_argument('--query_dir', type=str, default='/data/home/cunyuangao/datasets/valset')
    parser.add_argument('--gallery_dir', type=str, default='/data/home/cunyuangao/datasets/valset')
    # model
    parser.add_argument('--arch', type=str, default='HighResolutionNet_reid') 
    parser.add_argument('--num_classes', type=int, default=283) 
