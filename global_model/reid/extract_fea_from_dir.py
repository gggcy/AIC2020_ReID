...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='/data/home/cunyuangao/Project/AIC2020/src/output/arc_senet152_refine/pass155.pth.tar')
    ...
    parser.add_argument('--num_classes', type=int, default=2048) 
