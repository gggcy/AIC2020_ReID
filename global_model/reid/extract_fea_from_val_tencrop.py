...
class Ten_crop(object):
    def __init__(self, data_dir=None, transform=None):
        super(Ten_crop, self).__init__()
...
def get_real_test_data(query_dir, gallery_dir, target_height, target_width, batch_size, workers):
    ...
    test_transformer = T.Compose([
        ...
        torchvision.transforms.TenCrop((288,384), vertical_flip=False),
        T.ToTensor(),
        normalizer,
    ])  
    
    query_loader = DataLoader(
        Ten_crop(data_dir=query_dir,
                     transform=test_transformer),
        batch_size=batch_size, num_workers=workers,
        shuffle=False,pin_memory=True)
    
    gallery_loader = DataLoader(
        Ten_crop(data_dir=gallery_dir,
                     transform=test_transformer),
        batch_size=batch_size, num_workers=workers,
        shuffle=False,pin_memory=True)
...
def main(args):
    ...
    # g_file = open('labelsmooth_se152.pkl', 'wb')
    q_file = open('query_densenet_combine_off_cen.pkl', 'wb')
    g_file = open('gallery_densenet_combine_off_cen.pkl', 'wb')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default='/data/home/cunyuangao/Project/AICI2020/src/output/densenet_cosine_combine/pass840.pth.tar')
    ...
    parser.add_argument('--query_dir', type=str,
                        default='/data/home/public/data/AIC2020/AIC20_track2/AIC20_ReID/image_query')
    parser.add_argument('--gallery_dir', type=str,
                        default='/data/home/public/data/AIC2020/AIC20_track2/AIC20_ReID/image_test')
    # model
    parser.add_argument('--arch', type=str, default='densenet161')
    parser.add_argument('--num_classes', type=int, default=2028)
