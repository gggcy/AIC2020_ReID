...
class Complete_Aicity_Car(Dataset):
    ...
    def __init__(self, root, split_id=0, num_val=50, download=True):
        super(Complete_Aicity_Car, self).__init__(root, split_id=split_id)
    ...
    def download(self):
        ...
        meta = {'name': 'Complete_Aicity_Car', 'shot': 'multiple', 'num_cameras': 41,
