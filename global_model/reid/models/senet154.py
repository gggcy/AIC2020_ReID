...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
                 ...
                 downsample_padding=1, num_classes=1000, num_features=2048):
        """
        Parameters
        ----------
        ...
        self.dim_red_conv = nn.Conv2d(2048, self.num_features, 1, bias=False)
...
def initialize_pretrained_model(model, num_classes, settings):
    ...
    state_dict = torch.load('./pretrain_models/senet154-c7b49a05.pth')
...
def senet154(num_classes=1000, pretrained= 'imagenet',num_features = 2048):
    model = SENet(SEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
                  dropout_p=0.2, num_classes=num_classes, num_features=num_features)
