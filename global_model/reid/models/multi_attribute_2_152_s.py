...
__all__ = ['multi_attribute_2_resnet152_s']
...
class Multi_Attribute_ResNet_3(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, num_features, is_cls=True, test_attribute=False):
        ...
        self.cat_red_conv = nn.Conv2d(1536, self.num_features, 1, bias=False)
        ...
        self.type_fc = nn.Linear(512, 6, True)
        self.type_fc.apply(weights_init_classifier)
        self.color_fc = nn.Linear(512, 8, True)
    ...
    def forward(self, x):
        ...
        cat_x = torch.cat([cls_x, type_x, color_x], 1)
        ...
        if self.training:
            ...
            if self.is_cls:
                ...
                return final_cls_x, color_x, type_x, x_g

                #return final_cls_x, type_x, x_g
            else:
                #return type_x, x_g
                return color_x ,type_x, x_g
...
def multi_attribute_2_resnet152_s(pretrained=False, **kwargs):
    print('type model')
