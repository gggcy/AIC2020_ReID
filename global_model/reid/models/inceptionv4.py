...
class InceptionV4(nn.Module):
    ...
    def __init__(self, num_classes=1000, num_features=2048):
        ...
        self.dim_red_conv = nn.Conv2d(1536, self.num_features, 1, bias=False)
...
def inceptionv4(num_classes, num_features = 2048, pretrained='imagenet'):
    if pretrained:
        ...
        state_dict = torch.load('./pretrain_models/inceptionv4-8e4777a0.pth')
