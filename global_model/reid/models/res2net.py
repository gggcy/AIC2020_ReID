...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, baseWidth=26, scale=4, num_classes=1000, num_features = 2048):
        self.inplanes = 64
...
def res2net101_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load('./pretrain_models/res2net101_v1b_26w_4s-0812c246.pth')
